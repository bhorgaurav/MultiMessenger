...
public class WiFiBroadcastReceiver extends BroadcastReceiver {
    ...
    public WiFiBroadcastReceiver(WifiManager wifiManager, WifiFragment wifiFragment, boolean isWifiConnected) {
        super();
...
//                Toast.makeText(wifiFragment.getActivity(), "Found no WiFi direct network to connect to using wlan0", Toast.LENGTH_LONG).show();
            }
